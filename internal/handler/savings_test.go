...
func (m *mockSavingsRepo) List(ctx context.Context, userID int64, yearMonth string) ([]model.SavingsGoal, error) {
	return m.goals, nil
}

func (m *mockSavingsRepo) Create(ctx context.Context, userID int64, input model.SavingsGoalInput) (model.SavingsGoal, error) {
	g := model.SavingsGoal{
		ID:           1,
		Name:         input.Name,
...
func (m *mockSavingsRepo) Update(ctx context.Context, userID int64, id int64, input model.SavingsGoalInput) (model.SavingsGoal, error) {
	if len(m.goals) > 0 {
...
func (m *mockSavingsRepo) Delete(ctx context.Context, userID int64, id int64) error {
